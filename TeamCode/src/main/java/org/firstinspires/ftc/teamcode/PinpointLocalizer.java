...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 350.80453983212067; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2988.863987756665; // x position of the perpendicular encoder (in tick units)
    }
