...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2012.713585; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2444.45005; // x position of the perpendicular encoder (in tick units)
    }
